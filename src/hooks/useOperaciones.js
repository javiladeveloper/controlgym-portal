  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const { data, error } = await supabase
        ...
        .select('stock, producto:producto!inner(id, nombre, categoria, precio, stock_minimo, deleted_at, imagen_url, descripcion, visible_en_app, descuento_tipo, descuento_valor)')
        .eq('sede_id', sedeId)
