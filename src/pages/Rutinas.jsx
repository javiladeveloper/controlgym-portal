...
function RutinasImpl() {
  ...
  const socio = socios.data?.find((s) => s.id === socioId)
    || (socioId && socioId === location.state?.socioId
      ? { id: socioId, nombre: location.state?.socio || 'Socio', codigo: null, talla_m: null, peso_kg: null }
      : undefined)
          ...
          <Card className="mt-[18px] p-[19px]">
            <div className="flex flex-wrap items-end gap-4">
              ...
              <div className="flex flex-wrap gap-2.5">
                ...
                {/* Objetivo de catálogo (plan automático) */}
                <Chip label="Objetivo:" value={objetivosCatalogo.find((o) => o.id === socio.objetivo_id)?.nombre || '—'} accent />
              </div>
            </div>
          </Card>
