-- Progreso del socio para que el trainer lo vea antes de renovar la rutina.
-- Combina 4 fuentes en el periodo de la rutina ACTIVA del socio (vigencia_inicio..
-- vigencia_fin; si la rutina no tiene vigencia_inicio, fallback a los últimos 60
-- días). Solo lectura/agregación, security definer + aislamiento por empresa.
...
begin
  ...
  -- aislamiento: el socio debe ser de la empresa del llamante
