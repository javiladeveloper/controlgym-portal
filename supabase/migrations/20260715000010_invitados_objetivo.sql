-- Invitados (acompañantes 2x1/grupal) ahora piden DNI primero, y pueden
-- traer objetivo_id + email para que también se les asigne su rutina/dieta
-- automática (igual que al titular), no solo membresía.
